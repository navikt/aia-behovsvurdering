...
export type SituasjonSvar = PermittertSvar | DinSituasjon;
...
const saksbehandlingstiderDagpengerUrl = 'https://www.nav.no/saksbehandlingstider#dagpenger';
const konkurs_url =
...
const TILBAKE_TIL_JOBB = (props: VeiledningsProps) => {
    ...
    return (
        <>
            ...
            <h3 className={'mb-0'}>Hva må jeg gjøre nå?</h3>
            <BodyShort>
            ...
            <ReadMore header="Hva skjer nå om du har søkt eller mottar dagpenger?" className={'mt-4'}>
                ...
                <BodyShort className={'mb-4'}>Du får et brev om saken din og hva du skal gjøre.</BodyShort>
                <DagpengeSaksbehandlingstider />
            </ReadMore>
            <ReadMore header="Skal jeg fortsatt være registrert som arbeidssøker?" className={'mt-4'}>
                <BodyShort className={'mb-4'}>
...
const OPPSIGELSE = (props: VeiledningsProps) => {
    ...
    return (
        <>
            ...
            <ReadMore header="Hva skjer hvis du har søkt eller mottar dagpenger?" className={'mt-4'}>
                <BodyShort>
            ...
            <ReadMore header="Skal jeg fortsatt være registrert som arbeidssøker?" className={'mt-4'}>
                <BodyShort className={'mb-4'}>For å få dagpenger må du være registrert som arbeidssøker.</BodyShort>
                <BodyLong>
...
const ENDRET_PERMITTERINGSPROSENT = (props: VeiledningsProps) => {
    ...
    return (
        <>
            ...
            <ReadMore header="Hva skjer nå om du har søkt eller mottar dagpenger?" className={'mt-4'}>
                <BodyShort className={'mb-4'}>Du bør fortsette å sende inn meldekortene.</BodyShort>
                <DagpengeSaksbehandlingstider />
                <BodyShort className={'mb-4'}>
...
const NY_JOBB = (props: VeiledningsProps) => {
    ...
    return (
        <>
            <BodyShort>Vi baserer denne veiledningen på de opplysningene du har oppgitt.</BodyShort>
            <h3 className={'mb-0'}>Hva må jeg gjøre nå?</h3>
            <BodyShort className={'mb-4'}>Du bør lese mer om jobb i kombinasjon med dagpenger.</BodyShort>
            <ReadMore header="Skal jeg fortsatt være registrert som arbeidssøker?" className={'mt-4'}>
                <BodyShort className={'mb-4'}>For å få dagpenger må du være registrert som arbeidssøker.</BodyShort>
                <BodyLong>
                    Husk at du må sende meldekort og svare 'Ja' på spørsmålet om du ønsker å være registrert som
...
const SAGT_OPP = (props: VeiledningsProps) => {
    ...
    return (
        <>
            ...
            <ReadMore header="Hva skjer nå om du har søkt eller mottar dagpenger?" className={'mt-4'}>
                <BodyShort className={'mb-4'}>Du sa opp stillingen din {prettyPrintDato(oppsigelseDato)}.</BodyShort>
                <BodyShort className={'mb-4'}>
...
const VIL_BYTTE_JOBB = (props: VeiledningsProps) => {
    return (
        <>
            <BodyShort className={'mb-4'}>Veiledning for {props.valgtSituasjon}</BodyShort>
        </>
    );
};
...
const Veiledning = (props: VeiledningsProps) => {
    ...
    } else if (valgtSituasjon === DinSituasjon.VIL_BYTTE_JOBB) {
